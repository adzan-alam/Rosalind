...
Yet a second nucleic acid exists alongside DNA in the chromatin; this molecule, which possesses a different sugar called **ribose**, came to be known as **ribonucleic acid, or RNA**. RNA differs further from DNA in that it contains a base called **uracil** in place of **thymine**.
...
* **Given:** A DNA string $t$ having length at most $1000\text{ nt}$.
